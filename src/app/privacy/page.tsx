  ...
  return (
    <>
      ...
      <main className='min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-4xl mx-auto bg-white rounded-xl shadow-lg border border-gray-100 p-6 sm:p-10'>
          <h1 className='text-3xl sm:text-4xl font-bold text-gray-900 mb-8 text-center'>
            Terms of Service & Privacy
          </h1>
          <section className='mb-12'>
            <h2 className='text-2xl sm:text-3xl font-semibold text-gray-800 mb-6 pb-2 border-b-2 border-gray-200'>
              Terms of Service
            </h2>
            <div className='space-y-8'>
              <div>
                ...
                <ul className='list-disc list-inside space-y-2 text-gray-700 ml-2'>
                  <li>
                    BookWorm provides access to classic literary works that are
                    freely available in the public domain through Project
                    Gutenberg.
                  </li>
                  <li>
              ...
              <div>
                ...
                <p className='text-gray-700 mb-3'>
                  By using BookWorm, you agree to:
                </p>
                <ul className='list-disc list-inside space-y-2 text-gray-700 ml-2'>
                  ...
                  <li>
                    Acknowledge that BookWorm is an independent project and not
                ...
                <p className='text-gray-700 mt-3'>
                  BookWorm may enhance the reading experience by offering
                  features such as bookmarking, reading progress tracking, or
                  user collections &mdash; but all book content remains sourced from
                  Project Gutenberg.
                </p>
              </div>
            </div>
          ...
          <section className='mb-8'>
            ...
            <p className='text-gray-700'>
              <a
                href='mailto:privacy@bookworm.app'
                className='text-blue-600 hover:underline'
              >
                privacy@bookworm.com
              </a>
            </p>
          </section>
